...
namespace LiveFactory.Pusher
{
    public partial class Form1 : Form
    {
        ...
        private static CancellationTokenSource _SubmitCTS = new CancellationTokenSource();
        ...
        public void AppendLog(string strValue)
        {
            // 无返回值无参数用MethodInvoker委托，无返回值可有参数用Action委托，有返回值可有参数用Func委托
            listBox1.BeginInvoke(new Action<string>(msg => listBox1.Items.Add(msg)),
                new object[] { strValue });
        }
        #endregion
