...
namespace LiveFactory.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var model = await _liveChannelService.GetLiveChannelWeb();
            var view = IsMobile() ? "Index" : "MobileIndex";
            string DefaultUrl = _videoService.GetDefaultPlayUrl();
            ViewBag.DefaultUrl = DefaultUrl;

            ViewBag.Domain = _appSettings.Value.Qiniu.Domain;
            return View(view, model);
        }


        
        //public async Task UpdateVideoState(LiveChannelDto liveChannelDto)
        //{
        //    var liveChannelData = await _liveChannelService.Get(liveChannelDto.Id);
        //    liveChannelData.State= liveChannelDto.State; 
        //    await _liveChannelService.InsertOrUpdate(liveChannelData);
        //}
